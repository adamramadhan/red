...
#what-is-netcoid a{      font-family: 'Pacifico',serif;  font-size: 30px; text-decoration:underline;}
	...
	<div class="clearfix" id="red-content">
		<div id="invitation-closed">
			<div class="helloworld">Sedang mempersiapkan...</div>
			
		</div>
		<div id="invitation-closed-meta"><span id="what-is-netcoid"><div>invitasi #3 <strong>Hari ini</strong>, 17 juni 2011.</div></span></div>
			<?php $views->css('blog'); ?>
