<div style="height: 30px; background: none repeat scroll 0pt 0pt rgb(255, 255, 255); color: rgb(68, 68, 68); border: 1px solid rgb(231, 231, 231); margin-bottom: 10px; padding: 2px; width: 759px;"><p style="margin: 0pt auto; text-align: center; line-height: 29px;"><span style="position: relative;right: 5px;top: 2px;"><img src="/www-static/assets/images/i/megaphonebybigfunkychiken.gif"> </span>Hallo, Kami sedang voting <a href="/blog?id=6"><u>permintaan fitur #3</u></a> . Jangan lupa untuk <i>Ctrl + D</i> untuk Bookmark!</p></div>
